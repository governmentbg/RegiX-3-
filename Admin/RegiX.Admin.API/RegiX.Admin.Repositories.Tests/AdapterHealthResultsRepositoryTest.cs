...
{
    [TestClass]
    public class AdapterHealthResultsRepositoryTest
    {
        [TestMethod]
        public void SelectAll_ExistingAdapterHealthResultsSelectedBy_Admin()
        {
            ...
            var repository = new AdapterHealthResultsRepository(dbContext, contextMock.Object);
        ...
        [TestMethod]
        public void SelectAll_ExistingAdapterHealthTesultsSelectedBy_GlobalAdmin()
        {
            var dbContext = new TestDataContextFactory().Create();
