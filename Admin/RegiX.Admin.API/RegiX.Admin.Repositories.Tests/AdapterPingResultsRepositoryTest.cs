...
{
    [TestClass]
    public class AdapterPingResultsRepositoryTest
    {
        [TestMethod]
        public void SelectAll_ExistingAdapterOperationsSelectedBy_Admin()
        {
            ...
            var repository = new AdapterPingResultsRepository(dbContext, contextMock.Object);
        ...
        [TestMethod]
        public void SelectAll_ExistingAdapterOperationsSelectedBy_GlobalAdmin()
        {
            var dbContext = new TestDataContextFactory().Create();
