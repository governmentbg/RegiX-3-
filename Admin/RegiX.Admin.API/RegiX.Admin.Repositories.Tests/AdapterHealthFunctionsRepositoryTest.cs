...
{
    [TestClass]
    public class AdapterHealthFunctionsRepositoryTest
    {
        [TestMethod]
        public void SelectAll_ExistingAdapterHealthFunctionsSelectedBy_Admin()
        {
            ...
            var repository = new AdapterHealthFunctionsRepository(dbContext, contextMock.Object);
        ...
        [TestMethod]
        public void SelectAll_ExistingAdapterHealthFunctionsSelectedBy_GlobalAdmin()
        {
            var dbContext = new TestDataContextFactory().Create();
