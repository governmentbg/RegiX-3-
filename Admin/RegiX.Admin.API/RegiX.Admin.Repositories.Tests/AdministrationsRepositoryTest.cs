...
{
    [TestClass]
    public class AdministrationsRepositoryTest
    {
        [TestMethod]
        public void SelectAll_ExistingAdministrationSelectedBy_Admin()
        {
            ...
            var repository = new AdministrationsRepository(dbContext, contextMock.Object);
        ...
        [TestMethod]
        public void SelectAll_ExistingAdministrationSelectedBy_GlobalAdmin()
        {
            var dbContext = new TestDataContextFactory().Create();
