...
След стартиране на ["RegiX - Клиентско приложение"](https://client-regix.egov.bg/) се визуализира заглавната страница на приложението позволяваща регистрирането на нови потребители или вход за вече регистрирани такива.
...
При полънен идентификатор за вход с еАвт (ЕГН или ЛНЧ) е възможно потребителят да избере опцията за вход с използване на **Електронна автентикация**.
