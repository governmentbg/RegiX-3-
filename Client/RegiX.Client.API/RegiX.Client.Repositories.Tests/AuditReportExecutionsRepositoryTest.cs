...
{
    [TestClass]
    public class AuditReportExecutionsRepositoryTest
    {
        [TestMethod]
        public void SelectAll_ExistingAuditReportExecutions()
        {
            ...
            var repository = new AuditReportExecutionsRepository(dbContext, contextMock.Object);
