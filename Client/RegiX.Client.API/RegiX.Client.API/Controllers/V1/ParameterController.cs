...
namespace TechnoLogica.RegiX.Client.API.Controllers.V1
{
    ...
    [Authorize]
    public class ParameterController : ABaseController<ParameterInDto, ParameterOutDto, Parameters, int>
    {
        public ParameterController(IParameterService aBaseService)
            : base(aBaseService)
        {
        }
        ...
        [HttpPut("{aId}")]
        public override IActionResult Put(int aId, [FromBody] ParameterInDto aInDto)
        {
        ...
        [ApiExplorerSettings(IgnoreApi = true)]
        [HttpPost("")]
        public override IActionResult Post([FromBody] ParameterInDto aInDto)
        {
            return StatusCode(405);
        }
