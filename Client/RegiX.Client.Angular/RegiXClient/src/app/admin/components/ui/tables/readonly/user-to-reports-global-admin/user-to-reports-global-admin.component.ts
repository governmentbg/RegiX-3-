...
@Component({
  selector: 'app-user-to-reports-global-admin',
  templateUrl: './user-to-reports-global-admin.component.html',
  styleUrls: ['./user-to-reports-global-admin.component.scss'],
})
export class UserToReportsGlobalAdminComponent extends RemoteComponentWithForm<
  UserToReportModel,
