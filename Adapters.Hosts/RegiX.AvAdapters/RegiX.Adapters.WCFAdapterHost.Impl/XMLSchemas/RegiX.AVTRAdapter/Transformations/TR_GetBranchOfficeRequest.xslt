		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:GetBranchOfficeRequest">
						<h3 align="center">
							<span>
								<xsl:text>Входни параметри на Справка за актуално състояние на клон на търговско дружество</xsl:text>
							</span>
						</h3>
