...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/AV/TR/SubdeedsCommon" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/AV/TR/GetBranchOfficeResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:GetBranchOfficeResponse">
						<h2 align="center">
							<span>
								<xsl:text>Справка за актуално състояние на клон на търговско дружество</xsl:text>
							</span>
						</h2>
						<xsl:choose>
							...
							<xsl:otherwise>
								<span>
									<xsl:text>В Търговския регистър не са намерени данни за клон на търговско дружество по търсените критерии.</xsl:text>
								</span>
								<br/>
								<br/>
							</xsl:otherwise>
