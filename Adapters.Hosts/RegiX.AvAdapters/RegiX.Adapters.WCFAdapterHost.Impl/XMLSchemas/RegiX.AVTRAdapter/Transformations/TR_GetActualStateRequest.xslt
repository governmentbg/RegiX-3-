		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:ActualStateRequest">
						<h3 align="center">
							<span>
								<xsl:text>Входни параметри на справка за актуално състояние</xsl:text>
							</span>
						</h3>
