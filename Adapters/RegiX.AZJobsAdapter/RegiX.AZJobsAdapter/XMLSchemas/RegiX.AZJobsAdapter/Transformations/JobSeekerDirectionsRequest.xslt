		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<h3 align="center">
						<span>
							<xsl:text>Входни параметри на справка по ЕГН/ЛНЧ за насочвания на търсещо работа лице</xsl:text>
						</span>
					</h3>
					<xsl:for-each select="n1:JobSeekerDirectionsRequest">
						<table border="0">
							<tbody>
								<tr>
									<th>
