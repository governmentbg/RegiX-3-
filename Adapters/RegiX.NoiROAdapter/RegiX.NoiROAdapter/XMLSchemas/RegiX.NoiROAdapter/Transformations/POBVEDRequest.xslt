		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<h3 align="center">
						<span>
							<xsl:text>Входни параметри на справка за изплатено парично обезщетение за безработица по период на дата на ведомост /дата на плащане/</xsl:text>
						</span>
					</h3>
					<br/>
					<table border="0" width="100%">
						<tbody>
							<tr>
								...
								<td>
									<xsl:for-each select="n1:POBVEDRequest">
