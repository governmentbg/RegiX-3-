...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/ASP/Common" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/ASP/BenefitsForHeating/GetBenefitsForHeatingResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:GetBenefitsForHeatingResponse">
						<br/>
						<h3 align="center">
							<span>
						...
						<h2 align="center">
							<span>
								<xsl:text>Справка по ЕГН/ЛНЧ за отпуснати помощи за отопление по Наредба РД-07-5 към дата </xsl:text>
							</span>
										...
										<xsl:for-each select="n1:DecisionData">
											<tr valign="top">
												<td style="padding:2px; ">
													...
													<span>
														<xsl:value-of select="count(   ../ n1:DecisionData  )"/>
													</span>
												</td>
												<td style="padding:2px; ">
