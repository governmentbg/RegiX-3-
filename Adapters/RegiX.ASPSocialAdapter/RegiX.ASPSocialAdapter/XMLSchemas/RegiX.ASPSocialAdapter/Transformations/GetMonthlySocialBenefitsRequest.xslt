		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:GetMonthlySocialBenefitsRequest">
						<xsl:for-each select="n1:PersonData">
							<br/>
							<br/>
							<h3 align="center">
								<span>
									<xsl:text>Входни параметри за справка по ЕГН/ЛНЧ за отпуснати помощи по чл. 9 от ППЗСП</xsl:text>
								</span>
							</h3>
