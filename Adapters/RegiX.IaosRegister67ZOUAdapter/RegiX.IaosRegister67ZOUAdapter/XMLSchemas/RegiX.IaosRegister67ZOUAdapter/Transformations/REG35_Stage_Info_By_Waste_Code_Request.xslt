		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h3 align="center">
						<span>
							<xsl:text>Заявка за изготвяне на справка за извличане на информация за площадки по операция с отпадък в Регистър на разрешенията по чл. 67 ЗУО, в т.ч. на тези от тях с прекратено действие.</xsl:text>
						</span>
					</h3>
					<br/>
					<br/>
					<table style="width:50%; " align="center" border="0" width="100%">
						<tbody>
							<tr>
								...
								<td align="center">
									<xsl:for-each select="n1:REG35_Stage_Info_By_Waste_Code_Request">
