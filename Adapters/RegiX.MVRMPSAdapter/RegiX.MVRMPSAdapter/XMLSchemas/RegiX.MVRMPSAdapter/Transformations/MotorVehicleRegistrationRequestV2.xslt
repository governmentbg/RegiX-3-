		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h3 align="center">
						<span>
							<xsl:text>Входни данни за Разширена справка за МПС по регистрационен номер</xsl:text>
						</span>
					</h3>
					<br/>
					<br/>
					<table style="width:100%; " border="0" width="100%">
						<tbody>
							<tr>
								...
								<td>
									<xsl:for-each select="n1:GetMotorVehicleRegistrationInfoV2Request">
