		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h1 align="center">
						<span>
							<xsl:text>Разширена справка за МПС по регистрационен номер V3</xsl:text>
						</span>
					</h1>
					<br/>
					<xsl:for-each select="n1:GetMotorVehicleRegistrationInfoV3Response">
							...
							<xsl:for-each select="n1:Results">
								<xsl:for-each select="n1:Result">
									<xsl:for-each select="n1:VehicleData">
										...
										<xsl:for-each select="n1:MassF2">
											<br/>
											<span style="font-weight:bold; ">
												<xsl:text>(F.2) Допустима максимална маса, определена от компетентните органи: </xsl:text>
											</span>
											<xsl:apply-templates/>
										</xsl:for-each>
										<xsl:for-each select="n1:MassF3">
											<br/>
											<span style="font-weight:bold; ">
												<xsl:text>(F.3) Допустима максимална маса на състав от превозни средства:</xsl:text>
											</span>
											<span>
												<xsl:text>&#160;</xsl:text>
											</span>
										...
										<xsl:for-each select="n1:VehNumOfAxles">
											<br/>
											<span style="font-weight:bold; ">
												<xsl:text>(L) Брой оси:</xsl:text>
											</span>
											<span>
												<xsl:text>&#160;</xsl:text>
											</span>
										...
										<xsl:for-each select="n1:VehMassO1">
											<br/>
											<span style="font-weight:bold; ">
												<xsl:text>(O.1) Технически допустима максимална маса на тегленото ремарке със спирачната уредба:</xsl:text>
											</span>
											<span>
												<xsl:text>&#160;</xsl:text>
											</span>
										...
										<xsl:for-each select="n1:VehMassO2">
											<br/>
											<span style="font-weight:bold; ">
												<xsl:text>(O.2) Технически допустима максимална маса на тегленото ремарке без спирачната уредба:</xsl:text>
											</span>
											<span>
												<xsl:text>&#160;</xsl:text>
											</span>
