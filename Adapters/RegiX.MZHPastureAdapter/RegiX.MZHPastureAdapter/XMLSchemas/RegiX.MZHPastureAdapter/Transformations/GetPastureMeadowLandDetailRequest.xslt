		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<h3 align="center">
						<span>
							<xsl:text>Входни параметри на справка с детайли за ползване на пасища, мери и ливади</xsl:text>
						</span>
					</h3>
					<div align="center">
						...
						<xsl:for-each select="n1:PastureMeadowLandDetailRequest">
