		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:GetObligationDocumentsByEGNResponse">
						<h3 align="center">
							<span>
						...
						<h2 align="center">
							<span>
								<xsl:text>Проверка за налични неплатени документи в АИС АНД на дадено лице</xsl:text>
							</span>
						</h2>
