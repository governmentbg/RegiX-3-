...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/MVR/Common" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/MVR/ObligationDocuments/GetObligationDocumentsResponse" xmlns:ns1="http://egov.bg/RegiX/ASP/ObligationDocuments/GetObligationDocumentsResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="ns1:GetObligationDocumentsResponse">
						<h3 align="center">
							<span>
						...
						<h2 align="center">
							<span>
								<xsl:text>Справка за задълженията по конкретен документ, издаден от Пътна полиция</xsl:text>
							</span>
						</h2>
						...
						<br/>
						<br/>
						<xsl:for-each select="ObligationDocuments">
							<xsl:for-each select="ObligationDocument">
								<br/>
								<br/>
								<span style="font-weight:bold; ">
