		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:ActualStateRequestV3">
						<h3 align="center">
							<span>
								<xsl:text>Входни параметри на Справка за актуално състояние за всички вписани обстоятелства по раздели</xsl:text>
							</span>
						</h3>
