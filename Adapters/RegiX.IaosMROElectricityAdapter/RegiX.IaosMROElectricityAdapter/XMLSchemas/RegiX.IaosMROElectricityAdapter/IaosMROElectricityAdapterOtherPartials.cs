...
namespace TechnoLogica.RegiX.IaosMROElectricityAdapter
{
    public partial class MRO_EEO_Equipment_Category_Response
    {
        public bool ShouldSerializeAuthorization()
        {
            bool haveSomeValue = this.Authorization != null &&
                ...
                this.Authorization.ShouldSerializeEEOCategories()
                );
    ...
    public partial class Authorization
    {
        ...
        public bool ShouldSerializeEEOCategories()
        {
            bool haveSomeValue = this.EEOCategories != null &&
                (
                this.EEOCategories.ShouldSerializeEEOCategory()
                );

            if (!haveSomeValue)
            {
                this.EEOCategories = null;
            }
    ...
    {
        public bool ShouldSerializeEEOCategory()
        {
            //Here removing the empty elements from the array or collection
            if (this.EEOCategory != null)
            {
                this.EEOCategory = this.EEOCategory.Where(x => !string.IsNullOrEmpty(x)).ToList();
            }

            bool haveSomeValue = this.EEOCategory != null &&
                this.EEOCategory.Count() != 0;

            if (!haveSomeValue)
            {
                this.EEOCategory = null;
            }
    ...
    public partial class MRO_EEO_Execution_Type_Response
    {
        public bool ShouldSerializeAuthorization()
        {
            bool haveSomeValue = this.Authorization != null &&
    ...
    public partial class MRO_EEO_Trade_Marks_Response
    {
        public bool ShouldSerializeAuthorization()
        {
            bool haveSomeValue = this.Authorization != null &&
    ...
    public partial class MRO_EEO_Validity_Check_Response
    {
        public bool ShouldSerializeAuthorization()
        {
            bool haveSomeValue = this.Authorization != null &&
