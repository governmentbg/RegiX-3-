...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/DaeuReports/SearchByIdentifierResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
	...
	<xsl:import-schema schema-location="C:\Projects\RegiX\RegiX.DaeuReportsAdapter\XMLSchemas\SearchByIdentifierResponse.xsd" namespace="http://egov.bg/RegiX/DaeuReports/SearchByIdentifierResponse"/>
	<xsl:template match="/">
		<html>
			<head>
				<title/>
