...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/NCPR/Common" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/NCPR/MedicinalProducts/ListMedicinalProductsResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<h1 align="center">
						<span>
							<xsl:text>Справка по Търсене на лекарствени продукти в регистрите </xsl:text>
						</span>
					</h1>
					<xsl:for-each select="n1:ListMedicinalProductsResponse">
