		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h3 align="center">
						<span>
							<xsl:text>Справка по номер на марка - входни параметри</xsl:text>
						</span>
					</h3>
					<br/>
					<br/>
							...
							<tr>
								<td>
									<span style="font-weight:bold; ">
										<xsl:text>Номер на марка</xsl:text>
									</span>
								</td>
								<td>
									<xsl:for-each select="n1:GetMarkByRegNum">
