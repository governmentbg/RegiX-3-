...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/IAOS/TraderBroker/Common" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/IAOS/TraderBroker/WasteCodesByEIKResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<h2 align="center">
						<span>
							<xsl:text>Справка за кодове на отпадъци в Регистър на лицата, извършващи дейности като търговец и/или като брокер на отпадъци.</xsl:text>
						</span>
					</h2>
					<br/>
					<br/>
					<table style="width:85%; " align="center" border="1" width="100%">
						<tbody>
							<tr>
								...
								<td>
									<xsl:for-each select="n1:TRADER_BROKER_Waste_Codes_By_EIK_Response">
							...
							<tr>
								...
								<td>
									<ul>
										<xsl:for-each select="n1:TRADER_BROKER_Waste_Codes_By_EIK_Response">
											<xsl:for-each select="n1:Authorization">
												<xsl:for-each select="n1:WasteCodes">
