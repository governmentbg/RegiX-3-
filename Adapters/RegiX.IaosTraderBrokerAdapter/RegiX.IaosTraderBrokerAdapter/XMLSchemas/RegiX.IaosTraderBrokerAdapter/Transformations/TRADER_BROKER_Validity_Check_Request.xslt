		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h3 align="center">
						<span>
							<xsl:text>Заявка за изготвяне на справка за валидност в Регистър на лицата, извършващи дейности като търговец и/или като брокер на отпадъци.</xsl:text>
						</span>
					</h3>
					<br/>
					<br/>
					<table style="width:50%; " align="center" border="0" width="100%">
						...
						<tbody>
							<tr>
								...
								<td>
									<xsl:for-each select="n1:TRADER_BROKER_Validity_Check_Request">
