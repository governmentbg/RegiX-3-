			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="$XML">
						<h3 align="center">
							<span>
								<xsl:text>Заявка за изготвяне на справка за кодове на отпадъци в Регистър на лицата, извършващи дейности като търговец и/или като брокер на отпадъци. (Версия 2)</xsl:text>
							</span>
						</h3>
						<br/>
						<table style="width:50%; " align="center" border="0" width="100%">
							<tbody>
								<tr>
									...
									<td>
										<xsl:for-each select="n1:TRADER_BROKER_Waste_Codes_By_EIK_RequestV2">
