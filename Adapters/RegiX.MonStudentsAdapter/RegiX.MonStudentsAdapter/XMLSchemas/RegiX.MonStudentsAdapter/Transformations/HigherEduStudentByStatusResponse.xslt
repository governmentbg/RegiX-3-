			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:HigherEduStudentByStatusResponse">
						...
						<h2 align="center">
							<span>
								<xsl:text>Справка за всички студенти или докторанти със статус &quot;действащ&quot; и &quot;отчислен с право на защита&quot;, по подаден идентификатор</xsl:text>
							</span>
						</h2>
						<xsl:choose>
							...
							<xsl:otherwise>
								<span>
									<xsl:text>Няма данни в Регистър на всички действащи и прекъснали студенти и докторанти за съответните критерии</xsl:text>
								</span>
							</xsl:otherwise>
						</xsl:choose>
						<br/>
