...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/MON/HigherEdu/Common" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/MON/HigherEdu/HigherEduStudentResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:HigherEduStudentResponse">
						<br/>
						<h3 align="center">
							<span>
						...
						<h3 align="center">
							<span>
								<xsl:text>Регистър на всички действащи и прекъснали студенти и докторанти</xsl:text>
							</span>
						</h3>
						<br/>
						<h2 align="center">
							<span>
								<xsl:text>Справка за всички студенти или докторанти с всички статуси без ограничение, по подаден идентификатор - резултат</xsl:text>
							</span>
						</h2>
						<xsl:choose>
							...
							<xsl:otherwise>
								<span>
									<xsl:text>Няма данни в Регистър на всички действащи и прекъснали студенти и докторанти по зададените критерии.</xsl:text>
								</span>
							</xsl:otherwise>
						</xsl:choose>
						<br/>
