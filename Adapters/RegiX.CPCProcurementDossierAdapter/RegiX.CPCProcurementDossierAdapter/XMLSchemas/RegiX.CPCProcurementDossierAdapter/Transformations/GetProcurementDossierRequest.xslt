		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					...
					<h2 align="center">
						<span>
							<xsl:text>Входни параметри на Справка за жалби по ЗОП</xsl:text>
						</span>
					</h2>
					<table border="0">
						<tbody>
							<tr>
								...
								<xsl:for-each select="n1:GetProcurementDossierRequest">
									<td>
										<xsl:for-each select="n1:ProcurementNumber">
											<xsl:apply-templates/>
										</xsl:for-each>
									</td>
								</xsl:for-each>
