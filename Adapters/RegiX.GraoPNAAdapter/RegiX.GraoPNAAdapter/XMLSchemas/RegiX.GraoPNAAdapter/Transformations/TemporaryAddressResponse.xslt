...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://egov.bg/RegiX/GRAO/PNA" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/GRAO/PNA/TemporaryAddressResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:TemporaryAddressResponse">
						<h3 align="center">
							<span>
						...
						<h2 align="center">
							<span>
								<xsl:text>Справка за настоящ адрес</xsl:text>
							</span>
						</h2>
						<xsl:choose>
							...
							<xsl:otherwise>
								<span>
									<xsl:text>В регистъра не са намерени данни за настоящ адрес по подадените ЕГН и дата.</xsl:text>
								</span>
							</xsl:otherwise>
						</xsl:choose>
					</xsl:for-each>
