...
<!--Designed and generated by Altova StyleVision Enterprise Edition 2013 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:ncoocc="http://ereg.egov.bg/value/R-1045" xmlns:ncooeaqlc="http://ereg.egov.bg/value/R-1061" xmlns:ncoogc="http://ereg.egov.bg/value/R-1053" xmlns:ncooigc="http://ereg.egov.bg/value/R-1057" xmlns:ncoopc="http://ereg.egov.bg/value/R-1065" xmlns:ncoopn="http://ereg.egov.bg/value/R-1067" xmlns:ncoosc="http://ereg.egov.bg/value/R-1049" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="#all">
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;NKPD&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:variable name="altova:nPxPerIn" select="96"/>
	<xsl:import-schema schema-location="NKPDDataSchema.xsd"/>
	...
	<xsl:template name="altova:Root">
		<html>
			<head>
				<title/>
				<meta name="generator" content="Altova StyleVision Enterprise Edition 2013 (http://www.altova.com)"/>
			...
			<body>
				...
				<center>
					<xsl:for-each select="$XML">
						<xsl:for-each select="NKPDs">
							<xsl:for-each select="VersionName">
				...
				<xsl:variable name="altova:table">
					<table style="border-collapse:collapse; " border="1">
						...
						<tbody>
							<xsl:for-each select="$XML">
								<xsl:for-each select="NKPDs">
									<xsl:for-each select="NKPD">
										<xsl:sort select="if (substring( ClassCode,  0 ,  2 )  = &quot;0&quot;) then &quot;91&quot; else ClassCode" data-type="text" order="ascending"/>
										<xsl:sort select="SubclassCode" data-type="text" order="ascending"/>
										<xsl:sort select="GroupCode" data-type="text" order="ascending"/>
										<xsl:sort select="IndividualGroupCode" data-type="text" order="ascending"/>
										<xsl:sort select="substring( Code ,  6, 4)" data-type="text" order="ascending"/>
										<tr>
											<td>
												<xsl:choose>
													<xsl:when test="Type = &quot;nkpd&quot;">
														<xsl:for-each select="substring( Code ,  0 ,  5 )">
															<xsl:choose>
											...
											<td>
												<xsl:choose>
													<xsl:when test="Type = &apos;nkpd&apos;">
														<xsl:for-each select="substring( Code ,  5 )">
															<xsl:choose>
																<xsl:when test=". instance of element() or . instance of document-node()">
																	<xsl:apply-templates/>
																</xsl:when>
