...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cm="http://egov.bg/RegiX/MTSP/NKPD" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:n1="http://egov.bg/RegiX/MTSP/NKPD/AllNKPDDataResponse" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:altova="http://www.altova.com">
		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<br/>
					<xsl:for-each select="n1:AllNKPDDataResponse">
						<br/>
						<br/>
						<h3 align="center">
							<span>
						...
						<h2 align="center">
							<span>
								<xsl:text>Справка за търсене на целия класификатор НКПД</xsl:text>
							</span>
						</h2>
						<br/>
						<h3 align="center">
