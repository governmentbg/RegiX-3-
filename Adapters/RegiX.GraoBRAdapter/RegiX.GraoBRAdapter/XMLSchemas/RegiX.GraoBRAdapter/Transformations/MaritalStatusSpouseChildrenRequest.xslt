		...
		<html>
			...
			<body>
				<xsl:for-each select="$XML">
					<xsl:for-each select="n1:MaritalStatusSpouseChildrenRequest">
						<h3 align="center">
							<span>
								<xsl:text>Входни параметри на справка за семейно положение, съпруг/а и деца</xsl:text>
							</span>
						</h3>
