...
namespace RegiX.Info.API.Controllers
{
    ...
    [ApiController]
    public class SampleResponseXMLController : ControllerBase
    {
        ...
        public SampleResponseXMLController(IMemoryCache memoryCache, IDistributedCache distributedCache, IAdapterInformationLoader loader)
        {
        ...
        // GET api/SampleResponseXML/TechnoLogica.RegiX.MVRBDSAdapter.APIService.IMVRBDSAPI.GetPersonalIdentity
        [HttpGet("{id}")]
        public string Get(string id)
        {
            ...
            var XSD = currentOperation.SampleResponseXML;
