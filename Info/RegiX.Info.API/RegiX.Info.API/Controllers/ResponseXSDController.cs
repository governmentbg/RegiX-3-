...
namespace RegiX.Info.API.Controllers
{
    ...
    [ApiController]
    public class ResponseXSDController : ControllerBase
    {
        ...
        public ResponseXSDController(IMemoryCache memoryCache, IDistributedCache distributedCache, IAdapterInformationLoader loader)
        {
        ...
        // GET api/ResponseXSD/TechnoLogica.RegiX.MVRBDSAdapter.APIService.IMVRBDSAPI.GetPersonalIdentity
        [HttpGet("{id}")]
        public string Get(string id)
        {
            ...
            var XSD = currentOperation.ResponseXSD;
