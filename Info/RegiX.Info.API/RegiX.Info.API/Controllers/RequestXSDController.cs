...
namespace RegiX.Info.API.Controllers
{
    ...
    [ApiController]
    public class RequestXSDController : ControllerBase
    {
        ...
        public RequestXSDController(IMemoryCache memoryCache, IDistributedCache distributedCache, IAdapterInformationLoader loader)
        {
        ...
        // GET api/RequestXSD/TechnoLogica.RegiX.MVRBDSAdapter.APIService.IMVRBDSAPI.GetPersonalIdentity
        [HttpGet("{id}")]
        public string Get(string id)
        {
            ...
            var XSD = currentOperation.RequestXSD;
