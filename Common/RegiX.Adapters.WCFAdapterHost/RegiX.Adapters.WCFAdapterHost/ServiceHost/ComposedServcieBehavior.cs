...
namespace TechnoLogica.RegiX.Adapters.WCFAdapterHost.ServiceHost
{
    public class ComposedServiceBehavior : IServiceBehavior
    {
        ...
        public ComposedServiceBehavior(Type serviceType, string serviceName, CompositionContainer container)
        {
            _instanceProvider = new ComposedInstanceProvider(serviceType, serviceName, container);
        }
