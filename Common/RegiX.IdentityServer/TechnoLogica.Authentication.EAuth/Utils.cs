...
namespace TechnoLogica.Authentication.EAuth
{
    public static class Utils
    {
        ...
        public static AuthnRequestType GenerateNewSamlRequest(this EAuthOptions options)
        {
            ...
            result.AssertionConsumerServiceURL = options.RedirectConsumerServiceURL;
            result.Issuer = new NameIDType()
            {
                SPProvidedID = options.SystemProviderOID,
                Value = options.RedirectConsumerServiceURL
            };
