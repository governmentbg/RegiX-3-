...
using TechnoLogica.IdentityServer.Quickstart.Models;
...
namespace TechnoLogica.IdentityServer
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                var user = await _users.FindByUsername(IdentityServerConstants.DefaultCookieAuthenticationScheme, context?.Client.ClientId, model.Username);
                if (user != null &&
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                foreach (var provider in _compositionContainer.GetExportedValues<IAuthenticationProvider>())
                {
        ...
        public async Task<IActionResult> Register(string client, [FromBody] RegisterRequestViewModel model)
        {
            ...
            var result = await _users.RegisterUser(IdentityServer4.IdentityServerConstants.LocalIdentityProvider, client, model.Name, model.UserName, model.Email, model.Password, model.AdditionalAttributes);
            if (result.Succeeded)
            {
                return Ok();
            }
