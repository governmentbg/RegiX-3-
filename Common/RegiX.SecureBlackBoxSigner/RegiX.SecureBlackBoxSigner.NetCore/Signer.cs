...
namespace TechnoLogica.RegiX.SecureBlackBoxSigner.NetCore
{
    ...
    /// black box library for the .net core
    /// </summary>
        ...
        public override XmlElement Sign(XmlElement documentToSign)
        {
            ...
            try
            {
                ...
                Signer.KeyData =
                    ...
                    {
                        Certificate = TElX509CertificateFinder.GetCertificate()
                    };
                ...
                XAdESSigner.QualifyingProperties.SignedProperties.SignedDataObjectProperties.DataObjectFormats.Add(
                    new TElXMLDataObjectFormat(4) { MimeType = "text/xml", ObjectReference = "#r-id-1" }
                    );
